...
- Name: Landing Page >> integrations section shows platforms
- Location: /Users/govindroy/Documents/gorofolio/tests/e2e/landing-page.spec.ts:49:7

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: getByText('LinkedIn') resolved to 2 elements:
    1) <p class="text-gray-600 text-center leading-relaxed text-lg group-hover:text-gray-700 transition-colors">Generate a fully hosted portfolio site from your …</p> aka getByText('Generate a fully hosted')
    2) <h3 class="text-lg font-black text-gray-900 group-hover:text-gray-700 transition-colors mb-2">LinkedIn</h3> aka getByRole('heading', { name: 'LinkedIn' })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('LinkedIn')

    at /Users/govindroy/Documents/gorofolio/tests/e2e/landing-page.spec.ts:54:46
```
