...
- Name: Landing Page >> animations are working
- Location: /Users/govindroy/Documents/gorofolio/tests/e2e/landing-page.spec.ts:62:7
...
Expected pattern: /animate-fade-in-up|animation-delay/
Received string:  "relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden"
Call log:
  - expect.toHaveClass with timeout 5000ms
  - waiting for locator('section').first()
    9 × locator resolved to <section class="relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden">…</section>
      - unexpected value "relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden"

    at /Users/govindroy/Documents/gorofolio/tests/e2e/landing-page.spec.ts:65:31
```
