...
- Name: Editor Workflow >> can add new experience with auto-scroll
- Location: /Users/govindroy/Documents/gorofolio/tests/e2e/editor-workflow.spec.ts:16:7
...
Call log:
  - waiting for getByRole('button', { name: /add experience/i })

    at /Users/govindroy/Documents/gorofolio/tests/e2e/editor-workflow.spec.ts:19:65
```
