...
const DUMMY_PROFILES: Record<string, Profile> = {
  '123': {
    ...
    summary:
      'Experienced software engineer specializing in full-stack web development. Skilled in JavaScript, React, and cloud-based solutions with a strong background in leading agile teams.',
    experiences: [
      {
  ...
  '456': {
    ...
    summary:
      'Creative product designer with 6+ years of experience crafting user-centered digital experiences. Passionate about solving complex problems through elegant design solutions.',
    experiences: [
      {
