...
export async function POST(request: NextRequest) {
  try {
    const { sessionId, questionId, questionText, answer, category, difficulty, domain } =
      await request.json()
    ...
    const evaluation = {
      ...
      feedback: {
        ...
        detailed_feedback:
          'Your answer shows good understanding of the topic. Consider adding more concrete examples to strengthen your response.',
