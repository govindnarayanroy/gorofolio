                  ...
                  <div className="mt-6 space-y-4">
                    <div className="p-4 bg-green-50 border border-green-200 rounded-xl">
                      <div className="flex items-center mb-2">
                        ...
                        <h4 className="font-semibold text-green-900">Resume Parsed Successfully!</h4>
                      </div>
                      <p className="text-sm text-green-700 mb-3">
                        Your resume has been processed and saved. You'll be redirected to the editor automatically, or click below to continue.
                      </p>
                      <Link 
                    ...
                    <div className="p-4 bg-blue-50 border border-blue-200 rounded-xl">
                      <h4 className="font-semibold text-blue-900 mb-2">Other Options</h4>
